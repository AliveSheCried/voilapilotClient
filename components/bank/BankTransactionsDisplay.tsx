...
const columns: ColumnDef<BankTransaction>[] = [
  ...
  },
  {
    ...
    header: "Type",
    cell: ({ row }) => <div>{row.getValue("transaction_type")}</div>,
  },
  {
    accessorKey: "transaction_category",
    header: "Category",
    cell: ({ row }) => <div>{row.getValue("transaction_category")}</div>,
  },
  {
...
export default function BankTransactionsDisplay({ transactions }: { transactions: BankTransaction[] }) {
